...
public abstract class Movement : MonoBehaviour
{
	...
	protected virtual void Awake ()
	{
		...
		jumperfiFilter = jumper.GetComponent<Mesh>();
		MeshFilter mf1 = GameObject.CreatePrimitive(PrimitiveType.Sphere).GetComponent(typeof(MeshFilter)) as MeshFilter;
		jumperfiFilter = mf1.mesh;
	}
